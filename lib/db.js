...
export async function upsertExam(examData) {
  ...
  const { data: existing } = await supabase
    ...
    .gte('exam_date', startOfDay.toISOString())
    .lt('exam_date', endOfDay.toISOString())
    .single();
...
export async function upsertWhatsAppMessage(messageData) {
  const supabase = getSupabaseClient();
